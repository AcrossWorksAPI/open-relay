...
export function buildRelayWatchClaudePrompt(input: {
  ...
  return [
    ...
    "- provenance is optional; use [] or omit it when unsure.",
    "- provenance entries require type, reference, and supports.",
    "- provenance type must be pull_request, ci_run, commit, issue, user_note, or external_url.",
