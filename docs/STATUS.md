...
| Release workflow planning | In progress | PR #47 defines the recommended `@acrossworks/open-relay@0.1.0` first release gate, changelog/tag workflow, npm trusted publishing path, release preflight, and no-live-claim closeout rules. |
