...
| `docs/superpowers/plans/2026-06-27-relay-protocol-envelope.md` | Active | Implementation plan for schema registry, dispatching validator, renderer dispatcher, tests, and closeout. |
