...
| v0.1.0-pre.next | Local watcher proof | In progress | High | Required | Agent-ready prompt rendering; Boundary/transport decision | docs/superpowers/plans/2026-06-30-local-watcher-proof.md |
