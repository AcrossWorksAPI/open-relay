...
| Unversioned | Packet evidence enrichment | In progress | Medium | No | Relay protocol envelope and multi-type validation | docs/superpowers/specs/2026-06-28-review-request-evidence-enrichment-design.md |
