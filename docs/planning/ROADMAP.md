...
- Status: Product brief and foundation governance baseline
...
| --- | --- | --- | --- | --- | --- |
| Protocol | Minimal relay packet fields | Before CLI implementation | Candidate | Owner answers smallest useful packet question | - |
| Runtime | TypeScript or Python CLI runtime | Before implementation | Candidate | Owner chooses runtime or repo adds config | - |
| Templates | Codex/Claude review prompt templates | Alongside CLI MVP | Candidate | First packet schema is drafted | - |
