...
| v0.1.0-pre.next | Local response watch foreground orchestrator | In progress | High | Required | Local relay watch foreground orchestrator; Local relay status indicator; Resume-project packet type | docs/superpowers/plans/2026-07-01-local-response-watch.md |
