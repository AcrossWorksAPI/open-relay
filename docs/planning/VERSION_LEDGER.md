...
| Open-source hardening and first CI | In progress | 2026-06-26 | Branch `codex/open-source-hardening` | PR pending | N/A, docs/config baseline | Pending local and GitHub Actions checks | Revert hardening PR if it blocks contribution flow unexpectedly. |
