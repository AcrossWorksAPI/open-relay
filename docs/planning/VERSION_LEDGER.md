...
| Package/release smoke planning | In progress | 2026-06-26 | Planning branch `codex/package-release-planning` | Planning PR pending | N/A, docs/planning slice only | `npm run check` with 48 tests and `git diff --check` passed locally; design source `docs/superpowers/specs/2026-06-26-package-release-smoke-design.md`; implementation source `docs/superpowers/plans/2026-06-26-package-release-smoke.md` | Revert the planning commit if npm package target or tarball smoke criteria are rejected. |
