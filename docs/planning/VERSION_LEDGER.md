...
| Local handoff workflow planning | In progress | 2026-06-26 | Planning branch `codex/handoff-review-request-planning` | PR pending | N/A, docs/planning slice only | Design source `docs/superpowers/specs/2026-06-26-handoff-review-request-design.md`; implementation source `docs/superpowers/plans/2026-06-26-handoff-review-request.md`; `npm run check`, `npm run smoke:pack`, and `git diff --check` passed locally before PR | Revert the planning branch if the handoff command shape is rejected. |
