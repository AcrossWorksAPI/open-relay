...
| --- | --- | --- | --- | --- | --- | --- | --- |
| PC-001 | Protocol | Minimal relay packet schema | Applicable | Candidate | Smallest useful packet is defined | JSON schema validates a sample review-request packet | - |
...
| PC-006 | Release | Package, version, and release process | Future candidate | Candidate | Runtime/package manager selected | Release checklist and rollback path | - |
...
| PC-008 | Integration | MCP server readiness | Unknown; needs owner decision | Candidate | Owner chooses CLI plus MCP scope | Local MCP smoke with one packet-render tool | - |
