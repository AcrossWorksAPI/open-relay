...
| PC-002 | Templates | Agent-specific prompt dialects | Applicable | In progress | Agent-ready prompt output is the next brief-backed workflow gap after request/response packets and transport | Optional Codex/Claude wrappers preserve neutral Markdown output and avoid external agent invocation | docs/superpowers/plans/2026-06-28-agent-ready-prompt-rendering.md |
...
| PC-010 | AI governance | Provider-neutral prompt governance | Applicable | In progress | Templates target named agents | Templates keep packet Markdown neutral by default and isolate Claude/Codex behavior in optional render wrappers | docs/superpowers/plans/2026-06-28-agent-ready-prompt-rendering.md |
