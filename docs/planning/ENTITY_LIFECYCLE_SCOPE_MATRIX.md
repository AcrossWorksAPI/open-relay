...
| Render template | Shipped | Shipped | Planned | Planned | Planned | N/A | Shipped | Planned | Shipped | N/A | N/A | Shipped | Review-request Markdown renderer is merged with CLI route, package export, snapshot test, parser tests, escaping tests, and sanitized error handling; direct generator Markdown output implementation is active; agent-specific dialects remain deferred. |
