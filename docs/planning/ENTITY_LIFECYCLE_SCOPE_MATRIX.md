...
| Protocol envelope and packet registry | Planned | Planned | Planned | Planned | Planned | N/A | Planned | Planned | Planned | N/A | N/A | Planned | Roadmap re-anchor adds an envelope/type-version dispatch design before review-response, implementation-handoff, resume-project, or future packet versions. |
