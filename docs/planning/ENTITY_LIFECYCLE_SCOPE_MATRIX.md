...
| Render template | In progress | In progress | Planned | Planned | Planned | N/A | In progress | Planned | In progress | N/A | N/A | In progress | Renderer-first design and implementation plan are active; tooling remains unshipped until the implementation PR merges. |
