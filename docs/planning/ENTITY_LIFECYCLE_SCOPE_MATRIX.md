...
| Review loop | In progress | Future candidate | Future candidate | Future candidate | Future candidate | N/A | Future candidate | Future candidate | Future candidate | Deferred | N/A | In progress | Local `handoff review-request` planning is active for creating review handoff Markdown; review response, resume project, notifications, and external agent invocation remain future candidates. |
