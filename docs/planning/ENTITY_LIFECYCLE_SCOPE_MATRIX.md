...
| Runtime/deployment surfaces | Shipped | Shipped | Shipped | N/A | N/A | N/A | Shipped | Planned | Shipped | N/A | N/A | In progress | TypeScript package, CLI source, validation/generator/render tests, runtime CI, and local CLI smoke are merged; npm package target and tarball install smoke planning is active; registry publishing remains planned. |
