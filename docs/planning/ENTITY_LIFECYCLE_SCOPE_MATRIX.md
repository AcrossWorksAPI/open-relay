...
| Protocol envelope and packet registry | In progress | In progress | Planned | Planned | Planned | N/A | In progress | Planned | In progress | N/A | N/A | In progress | Implementation branch adds schema registry dispatch, renderer dispatch, supported-combination errors, and second-type proof tests before review-response, implementation-handoff, resume-project, or future packet versions. |
