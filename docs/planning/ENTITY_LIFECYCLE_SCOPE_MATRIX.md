...
| Review loop | Shipped | Future candidate | Future candidate | Future candidate | Future candidate | N/A | Future candidate | Future candidate | Future candidate | Deferred | N/A | Shipped | Local review-request handoff creation is shipped through `handoff review-request`; reviewer-produced response workflow planning is in progress; resume project, notifications, and external agent invocation remain future candidates. |
| Review response packet | Shipped | Shipped | In progress | Planned | Planned | N/A | Shipped | Planned | Shipped | Deferred | N/A | Shipped | PR #34 merged reviewer-authored `review-response` schema validation, semantic outcome checks, Markdown rendering, examples, generic render, package exports, protocol docs, package smoke, and block-rendered findings; generation/send composition is planned in `docs/superpowers/plans/2026-06-27-review-response-producer-workflow.md`; storage, notifications, native GitHub review import, and automation remain unbuilt. |
