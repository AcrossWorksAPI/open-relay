...
| Packet storage | In progress | Planned | Future candidate | Future candidate | Future candidate | N/A | Planned | Planned | Planned | Deferred | N/A | In progress | Repo-local `.open-relay/review-requests` implementation is active for saved review-request bundles; global storage, list/read/delete/archive, retention, and hosted sync remain deferred. |
