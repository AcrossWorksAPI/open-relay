...
| Relay packet | Planned | Shipped | Planned | Planned | Planned | N/A | Shipped | Planned | Planned | Deferred | N/A | Shipped | Review-request docs, examples, schema validation, and valid-example smoke exist; packet creation remains planned. |
| Relay packet schema | Shipped | Shipped | Planned | Planned | Planned | N/A | Shipped | Planned | Planned | N/A | N/A | Shipped | Formal JSON Schema and CLI validation are implemented; future schema versions need version-aware validation. |
...
| Runtime/deployment surfaces | Shipped | Shipped | Shipped | N/A | N/A | N/A | Shipped | Planned | Planned | N/A | N/A | Shipped | TypeScript package, CLI source, tests, runtime CI, and local validation smoke exist; package publishing and release smoke remain planned. |
