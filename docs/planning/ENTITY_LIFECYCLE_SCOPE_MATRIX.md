...
| Relay packet | Planned | Shipped | Planned | Planned | Planned | N/A | Shipped | Planned | Planned | Deferred | N/A | Shipped | Review-request docs, examples, and validation are shipped; packet creation is planned in the git-state generator slice. |
...
| Local repository context collector | Planned | Planned | Planned | N/A | N/A | N/A | Planned | Planned | Planned | N/A | N/A | Planned | Git-state generator plan covers base/head commits, changed files, safe remote metadata, and fail-closed redaction defaults. |
